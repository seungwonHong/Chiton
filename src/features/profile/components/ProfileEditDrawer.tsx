    ...
    <Drawer open={editOpen} onOpenChange={setEditOpen}>
      <DrawerContent className="bg-background border-border w-full h-full p-[1.4rem] !rounded-t-[2.4rem] outline-none">
        <DrawerHeader className="mb-[2rem]">
          <DrawerTitle className="text-[1.8rem] font-bold">
            Edit Profile
          </DrawerTitle>
        </DrawerHeader>
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <Input
            ...
            inputClassName="w-full h-[4rem] text-[1.4rem] px-[1rem] rounded-[0.8rem] mt-[0.8rem]"
            labelClassName="text-[1.6rem] text-normal"
          />
            ...
            {links.map((_, index) => (
              ...
              >
                <Input
                  ...
                  labelClassName="text-[1.6rem] text-normal gap-0"
                  inputClassName="rounded-[0.8rem] w-full h-[4rem] text-[1.4rem] pl-[1rem]"
            ...
            {techStacks.map((_, index) => (
              ...
              >
                <Input
                  ...
                  labelClassName="text-[1.6rem] text-normal gap-0"
                  inputClassName="rounded-[0.8rem] w-full h-[4rem] text-[1.4rem] pl-[1rem] pr-[4.8rem]"
                  addIconClassName="!w-[1.6rem] !h-[1.6rem]"
                />
                {index > 0 && (
                  <Trash2
          ...
          <DrawerFooter className="w-full p-0 mt-[6rem]">
            <Button
              type="submit"
              className="h-[4rem] text-[1.6rem] rounded-[0.8rem] cursor-pointer"
            >
              Save Changes
            </Button>
            ...
            <DrawerClose asChild>
              <Button
                type="button"
                variant="outline"
                className="border-border h-[4rem] text-[1.6rem] rounded-[0.8rem] cursor-pointer"
              >
                Cancel
              </Button>
            </DrawerClose>
